# nvim-treesitter-queries-fsh

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-fsh/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-fsh/actions/workflows/validate.yml)

Neovim tree-sitter queries for **fsh**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-fsh",
...
- [ ] Changes are scoped to `fsh` — do not include files for other languages
